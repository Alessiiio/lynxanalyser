...
- **Firmen-Watchlist**: Name öffnet das Profil (Netz aus Cache). Herkunft und Profil-Status (bereit / älter / offen) ohne Technik-Text. Nachts und per «Profile laden» (Admin) werden fehlende Profile nachgezogen.
